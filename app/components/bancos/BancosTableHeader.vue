  ...
  <thead class="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900">
    <tr class="border-b border-blue-700/50">
      <th 
        ...
        :key="column"
        class="group relative px-6 py-5 text-center cursor-pointer transition-all duration-300 hover:bg-white/5"
        draggable="true"
      ...
      >
        ...
        <div class="relative">
          <!-- Column title -->
          <div class="text-sm font-bold text-white group-hover:text-blue-200 transition-colors duration-300 tracking-wide">
            {{ columnTitles[column] }}
          </div>
