...
<script setup>
import { ref } from 'vue'
import { useEnviarAuditoriaComProgresso } from '~/composables/configuracoes/auditoria/analytics-financeiro/useEnviarAuditoriaComProgresso'
import ProgressModal from '~/components/configuracoes/auditoria/analytics_financeiro/ProgressModal.vue'
