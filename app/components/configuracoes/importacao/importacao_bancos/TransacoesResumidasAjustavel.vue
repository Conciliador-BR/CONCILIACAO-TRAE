...
const aliases = {
  'TICKET SERVICOS SA': ['TICKET SERVICOS SA', 'TICKET SERVICOS', 'TICKET', 'BANCO TOPAZIO', 'BANCO TOPAZIO SA', 'BANCO TOPAZIO S A', 'BANCO TOPAZIO S.A', 'BANCO TOPAZIO S.A.', 'TOPAZIO'],
