...
import { AUTORIZADA_MANUAL_COLUNAS_EDITAVEIS as colunasEditaveis } from '~/composables/PageControladoria/controladoria-vendas/adquirente_manual_vendas/constants'
