    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 gap-4">
      ...
      <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
        <div class="flex items-center space-x-3">
          ...
          <div>
            ...
            <p class="text-lg font-bold text-gray-900">{{ totalVendas.toLocaleString('pt-BR') }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <p class="text-xs font-medium text-gray-500 uppercase tracking-wide">V. Bruta</p>
            <p class="text-lg font-bold text-green-600">{{ formatCurrency(vendaBrutaTotal) }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <p class="text-xs font-medium text-gray-500 uppercase tracking-wide">V. Líquida</p>
            <p class="text-lg font-bold text-blue-600">{{ formatCurrency(vendaLiquidaTotal) }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <p class="text-xs font-medium text-gray-500 uppercase tracking-wide">Total MDR</p>
            <p class="text-lg font-bold text-red-500">{{ formatCurrency(totalMdr) }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <p class="text-xs font-medium text-gray-500 uppercase tracking-wide">Média MDR</p>
            <p class="text-lg font-bold text-orange-600">{{ formatPercentage(mediaTaxaMdr) }}</p>
          </div>
        </div>
      </div>
