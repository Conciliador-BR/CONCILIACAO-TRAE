...
const vendasBrutas = computed(() => props.dados.reduce((s, r) => s + toNumber(get(r, 'valor_bruto', ['valorBruto', 'valorRecebido'])), 0))
const vendasLiquidas = computed(() => props.dados.reduce((s, r) => s + toNumber(get(r, 'valor_liquido', ['valorLiquido'])), 0))
const taxas = computed(() => props.dados.reduce((s, r) => s + toNumber(get(r, 'despesa_mdr', ['taxaMdr', 'despesaMdr'])), 0))
...
const debitos = computed(() => {
  ...
  return rows.reduce((s, r) => s + Math.abs(toNumber(get(r, 'valor_bruto', ['valorBruto', 'valorRecebido']))), 0)
})
